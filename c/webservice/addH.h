...
SOAP_FMAC3 void * SOAP_FMAC4 add_instantiate(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 int SOAP_FMAC4 add_fdelete(struct soap_clist*);
...
inline struct ns__add * soap_new_req_ns__add(struct soap *soap, int num1, int num2) { struct ns__add *_p = soap_instantiate_ns__add(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__add(soap, _p); _p->num1 = num1; _p->num2 = num2; } return _p; }

inline struct ns__add * soap_new_set_ns__add(struct soap *soap, int num1, int num2) { struct ns__add *_p = soap_instantiate_ns__add(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__add(soap, _p); _p->num1 = num1; _p->num2 = num2; } return _p; }
...
inline struct ns__addResponse * soap_new_set_ns__addResponse(struct soap *soap, int *sum) { struct ns__addResponse *_p = soap_instantiate_ns__addResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__addResponse(soap, _p); _p->sum = sum; } return _p; }
